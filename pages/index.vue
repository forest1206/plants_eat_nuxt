          ...
          <div class="mt-5 flex-1 h-0 overflow-y-auto">
            <nav class="px-2">
              <div class="space-y-1">
                <a
                  href="#"
                  class="group flex items-center px-2 py-2 text-base leading-5 font-medium rounded-md text-gray-900 bg-gray-100 hover:text-gray-900 hover:bg-gray-100"
                >
                  <!-- Heroicon name: home -->
                  <svg
                    class="mr-3 h-6 w-6 text-gray-500 group-hover:text-gray-500"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                ...
                <a
                  href="#"
                  class="group flex items-center px-2 py-2 text-base leading-5 font-medium rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-50"
                >
        ...
        <div class="h-0 flex-1 flex flex-col overflow-y-auto">
          ...
          -->
            ...
            >
              <div class="py-1">
                <a
                  href="#"
                  class="block px-4 py-2 text-sm text-blue-riptide hover:bg-gray-100 hover:text-gray-900"
                  role="menuitem"
                  >View profile</a
                >
                <a
          ...
          <nav class="px-3 mt-6">
            <div class="space-y-1">
              <a
                href="#"
                class="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-900 bg-gray-200"
              >
                <!-- Heroicon name: home -->
                <svg
                  class="mr-3 h-6 w-6 text-gray-500 group-hover:text-gray-500"
